...
if args.session == 1:
    graph_path = '../data/icdm2022_session1_edges.csv'
    node_path = '../data/icdm2022_session1_nodes.csv'
    label_path = '../data/icdm2022_session1_train_labels.csv'
    store_path = '../data/icdm2022_session1'
