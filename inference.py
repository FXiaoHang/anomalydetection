...
parser.add_argument(
    "--test-file", type=str, default="../data/icdm2022_session1_test_ids.txt"
)
...
logger.info(
    f"Val: Loss: {val_loss:.4f}, Acc: {val_acc:.4f}, AP_Score: {val_ap:.4f},f1_macro: {f1_macro:.4f},gmean: {gmean:.4f},auc: {auc:.4f}"
)
